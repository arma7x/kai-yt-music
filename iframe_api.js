...
b.prototype.then=function(g,h){function k(r,p){return"function"==typeof r?function(w){try{l(r(w))}catch(B){m(B)}}:p}
...
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,m){function n(w){return function(B){r[w]=B;p--;0==p&&l(r)}}
...
function b(n){for(var r=g,p=0;64>p;p+=4)r[p/4]=n[p]<<24|n[p+1]<<16|n[p+2]<<8|n[p+3];for(p=16;80>p;p++)n=r[p-3]^r[p-8]^r[p-14]^r[p-16],r[p]=(n<<1|n>>>31)&4294967295;n=e[0];var w=e[1],B=e[2],z=e[3],O=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var P=z^w&(B^z);var G=1518500249}else P=w^B^z,G=1859775393;else 60>p?(P=w&B|z&(w|B),G=2400959708):(P=w^B^z,G=3395469782);P=((n<<5|n>>>27)&4294967295)+P+O+G+r[p]&4294967295;O=z;z=B;B=(w<<30|w>>>2)&4294967295;w=n;n=P}e[0]=e[0]+n&4294967295;e[1]=e[1]+w&4294967295;e[2]=
e[2]+B&4294967295;e[3]=e[3]+z&4294967295;e[4]=e[4]+O&4294967295}
function c(n,r){if("string"===typeof n){n=unescape(encodeURIComponent(n));for(var p=[],w=0,B=n.length;w<B;++w)p.push(n.charCodeAt(w));n=p}r||(r=n.length);p=0;if(0==l)for(;p+64<r;)b(n.slice(p,p+64)),p+=64,m+=64;for(;p<r;)if(f[l++]=n[p++],m++,64==l)for(l=0,b(f);p+64<r;)b(n.slice(p,p+64)),p+=64,m+=64}
...
F(Dc,Cc);Dc.prototype.reset=function(){this.h[0]=1732584193;this.h[1]=4023233417;this.h[2]=2562383102;this.h[3]=271733878;this.h[4]=3285377520;this.l=this.i=0};
...
function Ag(a,b,c,d){return J(a,function f(){var g=this,h,k,l,m,n,r,p,w,B,z,O,P;return y(f,function(G){switch(G.h){case 1:var N={mode:"readonly",C:!1};"string"===typeof c?N.mode=c:N=c;h=N;g.transactionCount++;k=h.C?Ce("ytidb_transaction_try_count",1):1;l=0;case 2:if(m){G.u(3);break}l++;n=Math.round(U());pa(G,4);r=g.h.transaction(b,h.mode);N=new Fg(r);N=Gg(N,d);return x(G,N,6);case 6:return p=G.i,w=Math.round(U()),Hg(g,n,w,l,void 0,b.join(),h),G.return(p);case 4:B=qa(G);z=Math.round(U());O=pg(B,g.h.name,
...
function Gg(a,b){var c=new Promise(function(d,e){sg(b(a).then(function(f){d(f)}),e)});
...
q.update=function(a){return X(this.cursor.update(a))};function Pg(a,b,c){return J(this,function e(){var f,g,h,k,l,m,n,r,p,w;return y(e,function(B){if(1==B.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.Ja,m=g.upgrade,n=g.closed,p=function(){r||(r=new zg(f.result,{closed:n}));return r},f.addEventListener("upgradeneeded",function(z){if(null===z.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");z.dataLoss&&"none"!==z.dataLoss&&cg("IDB_DATA_CORRUPTED",{reason:z.dataLossMessage||"unknown reason",dbName:gg(a)});var O=p(),P=new Fg(f.transaction);m&&m(O,z.oldVersion,z.newVersion,P)}),h&&f.addEventListener("blocked",function(){h()}),x(B,xg(f),2);
w=B.i;k&&w.addEventListener("versionchange",function(){k(p())});
w.addEventListener("close",function(){cg("IDB_UNEXPECTEDLY_CLOSED",{dbName:gg(a),dbVersion:w.version});l&&l()});
return B.return(p())})})}
...
function Ug(a){return J(this,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,Tg.open(),2);d=e.i;return e.return(Ag(d,["databases"],{C:!0,mode:"readwrite"},function(f){var g=Bg(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return X(g.h.put(a,void 0)).then(function(){})})}))})})}
function Vg(a){return J(this,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,Tg.open(),2);d=e.i;return e.return(d.delete("databases",a))})})}
;var Wg;
...
"objectStoreNames"in IDBTransaction.prototype))return f.return(new Zf(!1));pa(f,2);e={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return x(f,Ug(e),4);case 4:return x(f,Vg("yt-idb-test-do-not-use"),5);case 5:return f.return(new Zf(!0));case 2:return qa(f),f.return(new Zf(!1))}})})}
...
function $g(a,b,c,d){var e;return J(this,function g(){var h,k;return y(g,function(l){switch(l.h){case 1:return x(l,ah({caller:"openDbImpl",publicName:a,version:b}),2);case 2:return fg(a),h=c?{actualName:a,publicName:a,userIdentifier:void 0}:Zg(a),h.clearDataOnAuthChange=null!==(e=d.clearDataOnAuthChange)&&void 0!==e?e:!1,pa(l,3),x(l,Ug(h),5);case 5:return x(l,Qg(h.actualName,b,d),6);case 6:return l.return(l.i);case 3:return k=qa(l),pa(l,7),x(l,Vg(h.actualName),9);case 9:l.h=8;l.s=0;break;case 7:qa(l);
case 8:throw k;}})})}
function ah(a){return J(this,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,Yg(),2);if(!e.i)throw d=new V("IDB_NOT_SUPPORTED",{context:a}),bg(d),d;e.h=0})})}
function bh(a,b,c){c=void 0===c?{}:c;return $g(a,b,!1,c)}
function ch(a,b,c){c=void 0===c?{}:c;return $g(a,b,!0,c)}
function dh(a,b){b=void 0===b?{}:b;return J(this,function d(){var e;return y(d,function(f){if(1==f.h)return x(f,Yg(),2);if(3!=f.h){if(!f.i)return f.return();fg(a);e=Zg(a);return x(f,Rg(e.actualName,b),3)}return x(f,Vg(e.actualName),0)})})}
function eh(a,b){b=void 0===b?{}:b;return J(this,function d(){return y(d,function(e){if(1==e.h)return x(e,Yg(),2);if(3!=e.h){if(!e.i)return e.return();fg(a);return x(e,Rg(a,b),3)}return x(e,Vg(a),0)})})}
...
function kh(a){return J(this,function c(){var d,e,f,g,h;return y(c,function(k){switch(k.h){case 1:return d={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},x(k,lh(),2);case 2:return e=k.i,x(k,jh(),3);case 3:return f=k.i,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:e,interface:S("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),x(k,Eg(f,g),4);case 4:return h=k.i,d.Ka=U(),mh(d),k.return(h)}})})}
function nh(){return J(this,function b(){var c,d,e,f,g,h,k,l;return y(b,function(m){switch(m.h){case 1:return c={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},x(m,lh(),2);case 2:return d=m.i,e=S("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=["NEW",d,e,0],g=["NEW",d,e,U()],h=IDBKeyRange.bound(f,g),x(m,jh(),3);case 3:return k=m.i,l=void 0,x(m,Ag(k,["LogsRequestsStore"],{mode:"readwrite",C:!0},function(n){return Ng(Bg(n,"LogsRequestsStore").index("newRequest"),{query:h,direction:"prev"},function(r){r.cursor.value&&
(l=r.cursor.value,l.status="QUEUED",r.update(l))})}),4);
case 4:return c.Ka=U(),mh(c),m.return(l)}})})}
function oh(a){return J(this,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,jh(),2);d=e.i;return e.return(Ag(d,["LogsRequestsStore"],{mode:"readwrite",C:!0},function(f){var g=Bg(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",X(g.h.put(h,void 0)).then(function(){return h})})}))})})}
function ph(a){return J(this,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,jh(),2);d=e.i;return e.return(Ag(d,["LogsRequestsStore"],{mode:"readwrite",C:!0},function(f){var g=Bg(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,X(g.h.put(h,void 0)).then(function(){return h})):hh.resolve(void 0)})}))})})}
function qh(a){return J(this,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,jh(),2);d=e.i;return e.return(d.delete("LogsRequestsStore",a))})})}
function lh(){return J(this,function b(){var c;return y(b,function(d){if(1==d.h){Wf.h||(Wf.h=new Wf);var e={};var f=lc([]);f&&(e.Authorization=f,f=void 0,void 0===f&&(f=Number(S("SESSION_INDEX",0)),f=isNaN(f)?0:f),e["X-Goog-AuthUser"]=f,"INNERTUBE_HOST_OVERRIDE"in be||(e["X-Origin"]=window.location.origin),T("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in be&&(e["X-Goog-PageId"]=S("DELEGATED_SESSION_ID")));e instanceof Q||(f=new Q(Da),vd(f,2,e),e=f);return x(d,e,2)}c=d.i;e=d.return;f=Of(c);var g=
...
function xh(a){window.addEventListener("online",function(){return J(a,function c(){var d=this;return y(c,function(e){if(1==e.h)return d.l?x(e,d.L(),2):(d.h=!0,d.j&&M(d,"ytnetworkstatus-online"),e.u(2));Ah(d);d.P&&uh();e.h=0})})})}
function wh(a){window.addEventListener("offline",function(){return J(a,function c(){var d=this;return y(c,function(e){if(1==e.h)return d.l?x(e,d.L(),2):(d.h=!1,d.j&&M(d,"ytnetworkstatus-offline"),e.u(2));Ah(d);e.h=0})})})}
function zh(a){a.V=Ee(function(){return J(a,function c(){var d=this;return y(c,function(e){if(1==e.h){if(T("trigger_nsm_validation_checks_with_nwl")&&!d.h)return x(e,d.L(),3);if(d.Z()){if(!1!==d.h)return e.u(3);d.o=!0;d.v=U();return d.j?d.l?x(e,d.L(),11):(d.h=!0,M(d,"ytnetworkstatus-online"),e.u(11)):e.u(11)}if(!0!==d.h)return e.u(3);d.o=!0;d.v=U();return d.j?d.l?x(e,d.L(),3):(d.h=!1,M(d,"ytnetworkstatus-offline"),e.u(3)):e.u(3)}if(3!=e.h)return d.P&&uh(),e.u(3);zh(d);e.h=0})})},vh)}
function Ah(a){a.o&&(he(new eg("NetworkStatusManager state did not match poll",U()-a.v)),a.o=!1)}
q.L=function(a){var b=this;return this.B?this.B:this.B=new Promise(function(c){return J(b,function e(){var f,g,h,k=this;return y(e,function(l){switch(l.h){case 1:return f=window.AbortController?new window.AbortController:void 0,g=null===f||void 0===f?void 0:f.signal,h=!1,pa(l,2,3),f&&(k.U=Ge(function(){f.abort()},a||2E4)),x(l,fetch("/generate_204",{method:"HEAD",
...
b=void 0===b?{}:b;T("skip_is_supported_killswitch")?Yg().then(function(d){c(d)}):c(Mh())}
function Oh(){var a=this;Dh||(Dh=Ge(function(){return J(a,function c(){var d;return y(c,function(e){if(1==e.h)return x(e,nh(),2);if(3!=e.h)return d=e.i,d?x(e,Lh(d),3):(Ie(Dh),Dh=0,e.return());Dh=0;Oh();e.h=0})})},100))}
function Lh(a){return J(this,function c(){var d;return y(c,function(e){switch(e.h){case 1:if(void 0===a.id){e.u(2);break}return x(e,oh(a.id),3);case 3:(d=e.i)?a=d:he(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=U()-f)){e.u(4);break}he(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.u(5);break}return x(e,qh(a.id),5);case 5:return e.return();case 4:f=a=Ph(a);var g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:
...
a.options.onError=function(e,f){return J(b,function h(){return y(h,function(k){switch(k.h){case 1:if(!(T("trigger_nsm_validation_checks_with_nwl")&&(C("ytNetworklessLoggingInitializationOptions")?Gh.potentialEsfErrorCounter:Eh)<=Ce("potential_esf_error_limit",10))){k.u(2);break}return x(k,Ih().L(),3);case 3:if(Ih().J())C("ytNetworklessLoggingInitializationOptions")&&Gh.potentialEsfErrorCounter++,Eh++;else return c(e,f),k.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){k.u(4);break}return 1>
a.sendCount?x(k,ph(a.id),8):x(k,qh(a.id),4);case 8:Ge(function(){Ih().J()&&Oh()},5E3);
case 4:c(e,f),k.h=0}})})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){return J(b,function h(){return y(h,function(k){if(1==k.h)return void 0===(null===a||void 0===a?void 0:a.id)?k.u(2):x(k,qh(a.id),2);d(e,f);k.h=0})})};
return a}
...
function Gf(a,b,c,d){function e(r){r=void 0===r?!1:r;var p;if(d.retry&&"www.youtube-nocookie.com"!=h&&(r||(p=Sf(b,c,l,k)),p)){var w=g.onSuccess,B=g.onFetchSuccess;g.onSuccess=function(z,O){Tf(p);w(z,O)};
...
"Unknown Error";h=l.name||"UnknownError";var m=l.stack||e.i||"Not available";if(m.startsWith(h+": "+f)){var n=m.split("\n");n.shift();m=n.join("\n")}n=l.lineNumber||"Not available";l=l.fileName||"Not available";var r=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(r=ai(e.args[g],"params."+g,k,r),500<=r);g++);else if(e.hasOwnProperty("params")&&e.params){var p=e.params;if("object"===typeof e.params)for(g in p){if(p[g]){var w="params."+g,B=ci(p[g]);k[w]=B;r+=w.length+
